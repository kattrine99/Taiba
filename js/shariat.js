...
function shariatCardCreate(cardsData, cardsPerPage = 6) {
    let currentPage = 1;
        ...
        data.forEach(card => {
            ...
            el.innerHTML = `
                ...
                <div class="shariat-card-footer">
                  <span>${card.date}</span>
                  <a href="/shariat-card.html" class="btn">
                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12.0502 21.9503L21.9497 12.0508" stroke="currentColor" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M12.0503 12.0503H21.9498V21.9497" stroke="currentColor" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </a>
                </div>
